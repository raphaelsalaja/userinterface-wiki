// @ts-nocheck
import * as __fd_glob_9 from "../content/morphing-icons/index.mdx?collection=docs"
...
export const docs = await create.docs("docs", "content", {}, {"12-principles-of-animation/index.mdx": __fd_glob_0, "animating-container-bounds/index.mdx": __fd_glob_1, "generating-sounds-with-ai/index.mdx": __fd_glob_2, "laws-of-ux/index.mdx": __fd_glob_3, "mastering-animate-presence/index.mdx": __fd_glob_4, "skill/index.mdx": __fd_glob_5, "sounds-on-the-web/index.mdx": __fd_glob_6, "taking-advantage-of-pseudo-elements/index.mdx": __fd_glob_7, "to-spring-or-not-to-spring/index.mdx": __fd_glob_8, "morphing-icons/index.mdx": __fd_glob_9, });