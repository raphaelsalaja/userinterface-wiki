...
export const docs = await create.docs("docs", "content", {}, {"12-principles-of-animation/index.mdx": __fd_glob_0, "generating-sounds-with-ai/index.mdx": __fd_glob_1, "mastering-animate-presence/index.mdx": __fd_glob_2, "sounds-on-the-web/index.mdx": __fd_glob_3, "to-spring-or-not-to-spring/index.mdx": __fd_glob_4, "taking-advantage-of-pseudo-elements/index.mdx": __fd_glob_5, });