...
export const docs = await create.docs(
  ...
  {},
  {
    "12-principles-of-animation/index.mdx": __fd_glob_0,
    "mastering-animate-presence/index.mdx": __fd_glob_1,
    "sounds-on-the-web/index.mdx": __fd_glob_2,
    "taking-advantage-of-pseudo-elements/index.mdx": __fd_glob_3,
    "to-spring-or-not-to-spring/index.mdx": __fd_glob_4,
  },
);
