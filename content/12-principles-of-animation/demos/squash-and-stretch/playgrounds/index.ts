...
export const SquashAndStretchPlayground = {
  files: {
...
export const SquashAndStretchExercise = {
  starter: {
    files: {
...
export default function App() {
  ...
  return (
    <div className={styles.container}>
      <div className={styles.visual}>
        {/*
          TODO: The icon currently swaps with no sense of weight.
          Import { motion } from "motion/react" and turn this div into
          a motion.div that squashes and stretches on change:
            - key the element on \`icon\` so it re-animates on change
            - animate scaleX from 1.3 → 1 and scaleY from 0.8 → 1
            - use a bouncy spring (try stiffness 110, damping 2, mass 0.1)
        */}
