...
<Exercise
  prompt="The ball below snaps home with a fixed-duration ease, ignoring how you flicked it. Convert the release to a spring that preserves the gesture's velocity."
  {...SpringExercise}
/>
