...
[^6]: These ranges align with [Material Design's motion guidelines](https://m3.material.io/styles/motion/overview), which are a good starting point even outside Android.
